...
* **Languages:** C, C++, Python, SQL, Java (Basics)
* **Core CS:** Data Structures & Algorithms, OOP, Operating Systems, Computer Networks, DBMS, Distributed Systems
* **Cloud & DevOps:** AWS, Cloud Computing, Linux, Terraform, Docker
* **Developer Tools:** Git, GitHub, VS Code, MySQL Workbench, Jupyter Notebook, Google Colab, AWS CLI
